...
What argument did you use to make sure the data was read in correctly:
...
How many times does each variety appear in column 4?
How many times does each variety appear in row 5?
...
What is the mean yield for variety 1?
What is the standard deviation for variety 3? 
What is the standard error for variety 4?
...
How would you include the mean yield for each variety on the plot?
